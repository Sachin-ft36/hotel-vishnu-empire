      ...
      <main className="relative min-h-[90vh] flex flex-col items-center justify-center text-center px-6 pt-40 pb-20">
        ...
        >
          <div className="flex items-center justify-center gap-4 mb-8">
            ...
            <span className="eyebrow text-gold uppercase tracking-[0.4em] text-xs">Exclusives</span>
            <GoldDivider width="60px" />
          </div>
          ...
          <div className="max-w-2xl mx-auto space-y-6">
            <p className="text-soft-dim/80 text-lg md:text-xl font-light leading-relaxed italic">
              "We are orchestrating a new season of legendary privileges and royal indulgences."
            </p>
            
            <div className="pt-8">
              <p className="text-[0.65rem] small-caps text-gold/60 tracking-[0.3em] mb-4">Stay Tuned for the Reveal</p>

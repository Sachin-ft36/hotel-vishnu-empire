...
const HERITAGE_CHAPTERS = [
  {
    ...
    description: "Every arch, pillar, and facade at Vishnu Empire is a custodian of history. Our restoration process meticulously preserves the original craftsmanship while ensuring the highest standards of luxury.",
    image: "/oldphoto.jpg",
